    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
            ...
            <section class="column">
                ...
                <small>estimation from  edited files from  commits</small>
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    <mask id="languages-bar">
                        <rect x="0" y="0" width="460" height="8" fill="white" rx="5"/>
                    </mask>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="0" height="8" fill="#d1d5da"/>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="282.173401527711" height="8" fill="#f1e05a"/>
                    <rect mask="url(#languages-bar)" x="282.173401527711" y="0" width="78.78155664845214" height="8" fill="#f34b7d"/>
                    <rect mask="url(#languages-bar)" x="360.95495817616313" y="0" width="52.674871163927456" height="8" fill="#2b7489"/>
                    <rect mask="url(#languages-bar)" x="413.62982934009057" y="0" width="46.37017065990941" height="8" fill="#a91e50"/>
                </svg>
